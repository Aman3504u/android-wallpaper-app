...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull CoordinatorLayout rootView, @NonNull MaterialButton btnInfo,
      @NonNull MaterialButton btnPreview, @NonNull MaterialButton btnSetWallpaper,
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((CoordinatorLayout) rootView, btnInfo, btnPreview,
          btnSetWallpaper, btnSettings, toolbar);
    }
